...
public class PMenuBar extends JPanel{
	...
	public PMenuBar(){
		...
		logocon = new ImageIcon("resources/user/p_logo.png");
		...
		JPanel Label2 = new JPanel(new FlowLayout(FlowLayout.RIGHT,19,0))
		{
			public void paintComponent(Graphics g){
				 Dimension d = getSize();
	                g.drawImage(bgcon.getImage(), 0, 0, d.width, d.height, null);
		...
		JPanel hapP = new JPanel(new FlowLayout(50,10,8))
		{
			public void paintComponent(Graphics g){
				 Dimension d = getSize();
	                g.drawImage(bgcon.getImage(), 0, 0, d.width, d.height, null);
